...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static abstract class DBHelperItem implements BaseColumns {
        ...
        public static final String COLUMN_NAME_RECORDING_TYPE = "recording_type";
        public static final String COLUMN_NAME_RECORDING_SIZE = "recording_size";
    }
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBHelperItem.TABLE_NAME + " (" +
                    ...
                    DBHelperItem.COLUMN_NAME_RECORDING_TYPE + TEXT_TYPE +  COMMA_SEP +
                    DBHelperItem.COLUMN_NAME_RECORDING_SIZE + " INTEGER " + ")";
    ...
    public RecordingItem getItemAt(int position) {
        ...
        String[] projection = {
                ...
                DBHelperItem.COLUMN_NAME_RECORDING_TYPE,
        ...
        if (c.moveToPosition(position)) {
            ...
            item.setFileType(c.getString(c.getColumnIndex(DBHelperItem.COLUMN_NAME_RECORDING_TYPE)));
            item.setFileSize(c.getInt(c.getColumnIndex(DBHelperItem.COLUMN_NAME_RECORDING_SIZE)));
            c.close();
            return item;
        }
        return null;
    ...
    //for sorting or comapring the non-primitive objects
    ...
    public long addRecording(String recordingName, String filePath, long length, String fileType, int fileSize) {
        ...
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_TYPE, fileType);
